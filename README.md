...
## http://localhost:8080/ga-annotated-config/helloWorld
```console
DEBUG 2017-04-23 23:47:33,273 Request URI: /ga-annotated-config/helloWorld ~com.aspectran.web.service.WebAspectranService^service:108
DEBUG 2017-04-23 23:47:33,282 translet {name=/ga-annotated-config/helloWorld, requestRule={}, responseRule={response={responseType=transform, transformType=transform/xml, contentType=text/xml, pretty=false}}, aspectAdviceRuleRegistry={settings=2}} ~com.aspectran.core.activity.CoreActivity^prepare:146
...
INFO  2017-04-23 23:47:33,299 The message generated by my first aciton is: Hello, World. ~sample.SampleAction^helloWorld:30
...
## http://localhost:8080/ga-annotated-config/front/helloWorld
```console
DEBUG 2017-04-23 23:50:48,415 Request URI: /ga-annotated-config/front/helloWorld ~com.aspectran.web.service.WebAspectranService^service:108
DEBUG 2017-04-23 23:50:48,416 translet {name=/ga-annotated-config/front/${templateName}, method=[ALL], namePattern=/ga-annotated-config/front/*, requestRule={}, responseRule={response={responseType=dispatch, name=${templateName}}}} ~com.aspectran.core.activity.CoreActivity^prepare:146
...
DEBUG 2017-04-23 23:50:48,421 cache relevantAspectRuleHolder [/ga-annotated-config/front/helloWorld@class:sample.SampleAction^restHelloWorld] {dynamicAspectRuleList=[{id=sampleAspect, joinpointRule={joinpointType=translet, pointcutRule={pointcutPatternRule=[{translet=/ga-annotated-config/**/helloWorld, class=sample.SampleAction}]}}, aspectAdviceRuleList=[{aspectId=sampleAspect, aspectAdviceType=before, action={actionType=bean, beanActionRule={method=welcome}, aspectAdviceRule={aspectId=sampleAspect, aspectAdviceType=before}}}, {aspectId=sampleAspect, aspectAdviceType=after, action={actionType=bean, beanActionRule={method=goodbye}, aspectAdviceRule={aspectId=sampleAspect, aspectAdviceType=after}}}], beanRelevanted=true}]} ~com.aspectran.core.context.bean.proxy.AbstractDynamicBeanProxy^getRelevantAspectRuleHolder:80
...
INFO  2017-04-23 23:50:48,422 activityDataMap {templateName=helloWorld, title=The message generated by my first aciton is: } ~sample.SampleAdvice^goodbye:24
...
## http://localhost:8080/ga-annotated-config/echo/this-is-a-message
```console
DEBUG 2017-04-23 23:51:29,064 Request URI: /ga-annotated-config/echo/this-is-a-message ~com.aspectran.web.service.WebAspectranService^service:108
DEBUG 2017-04-23 23:51:29,064 translet {name=/ga-annotated-config/echo/${echoMsg}, method=[ALL], namePattern=/ga-annotated-config/echo/*, requestRule={}, responseRule={response={responseType=transform, transformType=transform/json, contentType=application/json, pretty=true}}} ~com.aspectran.core.activity.CoreActivity^prepare:146
...
DEBUG 2017-04-23 23:51:29,065 cache relevantAspectRuleHolder [/ga-annotated-config/echo/this-is-a-message@class:sample.SampleAction^restEchoMessage] {} ~com.aspectran.core.context.bean.proxy.AbstractDynamicBeanProxy^getRelevantAspectRuleHolder:80
INFO  2017-04-23 23:51:29,065 The message generated by my third aciton is: this-is-a-message ~sample.SampleAction^restEchoMessage:54
...
## http://localhost:8080/ga-annotated-config/echoParams?param1=1&param2=2
```console
DEBUG 2017-04-23 23:53:03,866 Request URI: /ga-annotated-config/echoParams ~com.aspectran.web.service.WebAspectranService^service:108
DEBUG 2017-04-23 23:53:03,866 translet {name=/ga-annotated-config/echoParams, requestRule={}, responseRule={response={responseType=transform, transformType=transform/json, contentType=application/json, pretty=true}}, aspectAdviceRuleRegistry={settings=2}} ~com.aspectran.core.activity.CoreActivity^prepare:146
...
DEBUG 2017-04-23 23:53:03,867 cache relevantAspectRuleHolder [/ga-annotated-config/echoParams@class:sample.SampleAction^echoParams] {} ~com.aspectran.core.context.bean.proxy.AbstractDynamicBeanProxy^getRelevantAspectRuleHolder:80
